...
$res=mysqli_query($data,"select * from registration where id=$id");
...
<aside id="left-panel" class="left-panel">
    ...
    <div class="content mt-3">
        ...
        <input type="text" name= "firstname" id="company" class="form-control" value="<?php echo $firstname; ?>">
        </div> <br>
                    
        <div class="form-group">
        <label for="company" class=" form-control-label">Last Name : </label>
        <input type="text" name= "lastname" id="company" class="form-control" value="<?php echo $lastname; ?>">
        </div> <br>

        <div class="form-group">
        <label for="company" class=" form-control-label">User Name : </label>
        <input type="text" name= "username" id="company" class="form-control" value="<?php echo $username; ?>">
        </div> <br>

        <div class="form-group">
        <label for="company" class=" form-control-label">Password : </label>
        <input type="text" name= "password" id="company" class="form-control" value="<?php echo $password; ?>">
        </div> <br>
        ...
        <input type="text" name= "email" id="company" class="form-control" value="<?php echo $email; ?>">
        </div> <br>

        <div class="form-group">
        <label for="company" class=" form-control-label">Phone Number : </label>
        <input type="text" name= "phonenumber" id="company" class="form-control" value="<?php echo $phonenumber; ?>">
        </div> <br>

        <div class="form-group">
        <label for="company" class=" form-control-label">Address : </label>
        <textarea name="address" id="textarea-input" rows="5" class="form-control"><?php echo $address; ?></textarea>
        </div>
